...
import top.cutexingluo.tools.designtools.http.base.WebHandler;
...
public class WebLogKeyMap {
    ...
    public String getValue(@NotNull String key, int mapIndex, @NotNull WebLogConfig config, @NotNull AspectBundle bundle) {
        switch (mapIndex) {
            ...
            case 3:
                WebHandler handler = keyHttpConverterMap.get(key);
                return handler == null ? null : handler.apply(bundle.getMethod(), bundle.getRequest());
            case 4:
            ...
            default:
                ...
                if (s == null) {
                    ...
                    if (supplier == null) {
                        ...
                        return handler2.apply(bundle.getMethod(), bundle.getRequest());
                    }
                    return supplier.get();
                }
                return s;
