...
public class XTObjUtil {
    ...
    public static class Unsafe {
         ...
         * @return {@link T}
         */
        public <T> T setNull(@NonNull T item, @NonNull String... properties) {
         ...
         * @return {@link T}
         */
        public <T> T setProperty(@NonNull T item, @NonNull String property, Object newValue) {
            try {
         ...
         * @return {@link T}
         */
        public <T> T setPropertyAllFields(@NonNull T item, Consumer<Field> fieldConsumer) {
         ...
         * @return {@link T}
         */
        public <T> T setPropertyContains(@NonNull T item, @NonNull Consumer<Field> fieldConsumer, @NonNull String... propertyNames) {
            Field[] fields = item.getClass().getDeclaredFields();
            HashSet<String> set = SetUtils.hashSet(propertyNames);
            for (Field field : fields) {
                field.setAccessible(true);
         ...
         * @return {@link T}
         */
        public <T> T setProperty(@NonNull T item, @NonNull Consumer<Field> fieldConsumer, @NonNull String... propertyNames) {
         ...
         * @return {@link Object}
         */
        public <T> Object getProperty(@NonNull T item, @NonNull String property) {
            Object result;
            try {
                Field field = item.getClass().getDeclaredField(property);
                field.setAccessible(true);
     ...
     */
    public static <T> Object getProperty(@NonNull T item, @NonNull String property, boolean isDone) {
        Object value = null;
    ...
    public static <T> Object getProperty(@NonNull T item, @NonNull String property) {
     ...
     * @param <T>      对象类型
     */
    public static <T> T setProperty(@NonNull T item, @NonNull String property,
                                    Object newValue, boolean isDone, @NonNull Class<?> param) {
    ...
    public static <T> T setProperty(@NonNull T item, @NonNull String property,
                                    Object newValue, @NonNull Class<?> param) {
     ...
     * @param <T>      对象类型
     */
    public static <T> List<Object> getListProperty(@NonNull List<T> items, String property) {
     ...
     * @param <T>      对象类型
     */
    public static <T> List<T> setListProperty(@NonNull List<T> items, String property, Object newValue, Class<?> param) {
