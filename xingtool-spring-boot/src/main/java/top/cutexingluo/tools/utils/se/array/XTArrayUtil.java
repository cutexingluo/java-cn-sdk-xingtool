...
public class XTArrayUtil {
     ...
     * @since 1.0.3
     */
    public static <T> void movePos(@NonNull T[] array, int offset) {
     ...
     * @since 1.0.3
     */
    public static <T> T[] movePos(@NonNull T[] array, int offset, @NonNull T[] newArray) {
        Objects.requireNonNull(array, "array should not be null");
     ...
     * @since 1.0.3
     */
    public static <T> T[] movePosCycle(@NonNull T[] array, int offset, @NonNull T[] newArray) {
        Objects.requireNonNull(array, "array should not be null");
        Objects.requireNonNull(newArray, "array should not be null");
        if (array.length == 0) {
            return newArray;
