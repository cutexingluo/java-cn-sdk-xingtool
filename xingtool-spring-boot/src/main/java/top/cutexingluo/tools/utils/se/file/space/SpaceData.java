...
public class SpaceData {
    ...
    @NotNull
    @Contract("_, _ -> new")
    public static SpaceData of(long size, @NonNull SpaceEnums spaceEnums) {
     ...
     * @param spaceEnums 当前单位
     */
    public SpaceData(long size, @NonNull SpaceEnums spaceEnums) {
     ...
     */
    @NotNull
    public static HashMap<SpaceEnums, Long> getMap(long size, @NonNull SpaceEnums spaceEnums) {
