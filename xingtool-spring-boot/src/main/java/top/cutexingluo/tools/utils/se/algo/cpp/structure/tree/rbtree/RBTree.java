...
public class RBTree<K extends Comparable<K>, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Iterable<Map.Entry<K, V>>, Serializable {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    static class RBNode<K extends Comparable<K>, V> implements BaseBiNodeSource<RBNode<K, V>>, BaseEntryBiNode<RBNode<K, V>, K, V>, IData<Map.Entry<K, V>> {
        ...
        public RBNode(Map.Entry<K, V> entry) {
