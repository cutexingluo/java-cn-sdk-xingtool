...
public class XTFile implements XTFileSource {
     ...
     * @throws IOException IOException
     */
    public XTFile(MultipartFile file, boolean useOriginalFilenameFirst) throws IOException {
     ...
     * @throws IOException IOException
     */
    public XTFile(MultipartFile file, boolean useOriginalFilenameFirst, boolean genMd5, boolean genUUID) throws IOException {
    ...
    public String genMd5(MultipartFile file) throws IOException {
        if (StrUtil.isBlank(this.md5)) this.md5 = SecureUtil.md5(file.getInputStream());
        return md5;
    }
